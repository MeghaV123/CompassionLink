...
function RecipientDonationsTable() {
    ...
    if (userdata && userdata._id) {
        fetch(`http://localhost:4000/admin/ViewNonMonetaryDonations`)
            ...
            .then((result) => {
                ...
                const userDonations = result.filter(donation => donation.donationId.recipientId === recipientId);
...
export default RecipientDonationsTable;
