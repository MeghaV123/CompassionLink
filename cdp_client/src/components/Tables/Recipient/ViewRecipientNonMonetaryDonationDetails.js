...
function ViewRecipientNonMonetaryDonationDetails() {
                ...
                <div className="bg-secondary rounded h-100 p-4 text-center">
                  ...
                  <div className="mt-4">
                    ...
                    //   onClick={handleApproval}
                      disabled={isAccepted}
                    >
                      {isAccepted ? "Delivery Accepted" : "Delivery not yet accepted"}
                    </button>
                  </div>
...
export default ViewRecipientNonMonetaryDonationDetails;
